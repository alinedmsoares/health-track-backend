...
<head>
    ...
    <title>Nova Medição | Health Track</title>
</head>
    ...
    <div class="main pressao">
        ...
        <div class="header">
            ...
            <div class="text">
                ...
                <div class="title">Nova medição</div>
        ...
        <form class="form" action="adicionar" method="post">
            ...
            <div class="item">
                ...
                <input class="input" type="text" name="sistolica" required>
            </div>

            <div class="item">
                <label for="diastolica">Pressão diastólica (mmHg)</label>
                <input class="input" type="text" name="diastolica" required>
            </div>
