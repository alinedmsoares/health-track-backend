    ...
    <div class="main pressao">
        ...
        <div class="header">
            ...
            <div class="text">
                ...
                <div class="title">Pressão Arterial</div>
        ...
        <div class="btn-area">
            ...
            <div class="button">
                ...
                <button class="primary"><a href="pressao/adicionar">Nova medição</a></button>
                ...
                <c:forEach items="${listaPressao}" var="pressao">
                    ...
                    <tr>
                        ...
                        if (Integer.parseInt(pageContext.getAttribute("status").toString()) >= 140) {
                        	out.print("Pressão alta");
                        } else {
                        	out.print("Pressão normal");
                        }
                        %>
                        </td>
                        
                        <form id="btn-editar" action="pressao/editar" method="post">
                        <input type="hidden" name="idPressao" value="${pressao.idPressao}">
                        <td><i class="fas fa-pen" onclick="editar()"></i></td>
                        </form>
                        
                        <form id="btn-excluir" action="pressao/excluir" method="post">
                        <input type="hidden" name="idPressao" value="${pressao.idPressao}">
